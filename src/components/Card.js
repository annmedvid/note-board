    ...
    render({ note }, { showEditView }) {
        const ordinaryView = (
            <div className="view">
                ...
                <div className="options">
                    <Icon type="garbage" className="icon" onClick={this.deleteNote} />
        ...
        const editorView = (
            <div className="view">
                ...
                <div className="options">
                    <Icon type="cancel" className="icon" onClick={this.changeView} />
                    <Icon type="ok" className="icon" onClick={this.editNote} />
                </div>
            </div>
        );
